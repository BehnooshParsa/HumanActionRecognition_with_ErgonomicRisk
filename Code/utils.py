...
def imshow_(x, **kwargs):
	...
	# print(values)
	col_list = ["light yellow", "gunmetal","hot pink","baby blue","green blue", "baby pink","blood red","magenta", "dusky blue","neon purple","pale grey","cool blue","neon blue", "brown","acid green","orange","viridian","reddish orange","dark magenta", "twilight blue"]
